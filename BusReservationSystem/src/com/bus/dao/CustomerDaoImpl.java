...
public class CustomerDaoImpl implements CustomerDao{
	...
	public void viewBusDetails() {
        ...
        ResultSet rs =ps.executeQuery();
//        | busNo | bName    | routeFrom | routeTo | bType | departure   | arrival  | totalSeats | availSeats | fare
        if(rs.next()) {
        	...
        	String bType = rs.getNString("bType");
...
//        	System.out.println("  "+busNo +"  |  "+ routeFrom +"  |  "+ routeFrom +"  |  "+ routeTo +"   "+ dep +"  |  "+ arr +"  |  "+ total +"  |  "+avail +"  |  "+ fare);
        	System.out.println(" "+busNo+"    |   "+bName+"      | "+routeFrom+"  |    "+routeTo+"   |    "+bType+"   |  " +dep+"    |   "+arr+"    |  "+total+"   |  "+avail+" | "+fare);

      /*
       | busNo |   bName   | routeFrom | routeTo | bType |       departure        |       arrival     | totalSeats | availSeats | fare

        10     |   10      | mubai     |  pune  |  AC  |  2022-11-14 02:00:00    |   2022-11-14 05:00:00    | 100  |  80  500
       ------------------------------------------------------------------------------------------------------------------------------
        */
